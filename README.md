...
* [data_raw](./data_raw) - folder containing raw data
  * flow.csv: all traffic data of termite on the emigration trail
  * working_nymph_data.csv: list of the observation of working nymphs
  * sleap_trajectory: foldier containing .h5 file for sleap trajectory
